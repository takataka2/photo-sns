...
import photo_db
import sns_user as user
import sns_data as data
import os, time
import pdb
import sqlite3
...
def chatroom_post(other_id):
    if "login" in session:#http://192.168.1.27:5000/chatroom/None
        # まずはチャットルームがあるかchatidをとってくる
        # session['login']でユーザーの名前を取得する。取得したユーザー名からmy_idを求める。
